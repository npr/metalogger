...
exports = module.exports = function(level) {
  ...
  if ('NODE_LOGGER_FACILITY' in process.env && process.env.NODE_LOGGER_SYSLOG_FACILITY) {
    options.facility = process.env.NODE_LOGGER_SYSLOG_FACILITY;
  }

  if ('NODE_LOGGER_APPNAME' in process.env && process.env.NODE_LOGGER_SYSLOG_APPNAME) {
